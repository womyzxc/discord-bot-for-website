...
class Help(commands.Cog):
    ...
    def get_antinuke_embed(self) -> discord.Embed:
        ...
        embed.description = (
            ...
            "✖️ `/nukewebhooks` ➖ Delete all webhooks\n\n"
            "**Channel Recovery**\n"
            "➕ `/restore` ➖ View deleted channels\n"
            "➕ `/restore_channel <num>` ➖ Restore a channel\n"
            "✖️ `/restore_clear` ➖ Clear restore list\n\n"
            "**Protection Includes**\n"
    ...
    def get_whitelist_embed(self) -> discord.Embed:
        ...
        embed.description = (
            ...
            "**Clear Whitelist**\n"
            "✖️ `/wlist clear` ➖ Clear everything\n"
            "✖️ `/wlist clear users|roles|bots`\n\n"
    ...
    def get_backup_embed(self) -> discord.Embed:
        ...
        embed.description = (
            ...
            "✖️ `/backup delete <version>` ➖ Delete backup\n"
            "✖️ `/backup clear` ➖ Delete all backups\n\n"
            "**Settings**\n"
    ...
    def get_mod_embed(self) -> discord.Embed:
        ...
        embed.description = (
            ...
            "**Channel Management**\n"
            "✖️ `/purge [amount]` ➖ Delete messages\n"
            "✖️ `/purge @user [amount]` ➖ User msgs\n"
    ...
    def get_owner_embed(self) -> discord.Embed:
        ...
        embed.description = (
            ...
            "✖️ `/botstatus clear` ➖ Remove activity\n\n"
            "**Server Management**\n"
